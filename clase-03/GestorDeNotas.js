...
manager.create({ text: "Hacer la compra del super" });
...
manager.create({ text: "Preparar la presentación", type: "ugente" });
...
console.log(`- ID: ${specificNote.id} | Tipo: ${specificNote.type} | Texto: ${specificNote.text} | Fecha: ${specificNote.date}`);
